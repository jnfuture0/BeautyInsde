...
class FragmentList1_12 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "폴리시").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "베이스/탑코트").findAll()
        ...
        val thirdAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "네일스티커").findAll()
        ...
        val fourthAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "페디스티커").findAll()
        ...
        val fifthAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "네일케어").findAll()
        ...
        val sixAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "네일리무버").findAll()
        ...
        val sevenAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "네일도구").findAll()
        ...
        boardList.add(Board("폴리시", firstList,0))
        boardList.add(Board("베이스/탑코트",secondList,0))
        boardList.add(Board("네일스티커",thirdList,0))
        boardList.add(Board("페디스티커",fourthList,0))
        boardList.add(Board("네일케어",fifthList,0))
        boardList.add(Board("네일리무버",sixList,0))
        boardList.add(Board("네일도구",sevenList,0))
