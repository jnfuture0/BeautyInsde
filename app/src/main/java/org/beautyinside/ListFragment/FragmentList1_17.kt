...
class FragmentList1_17 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "피부건강").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "다이어트").findAll()
        ...
        val thirdAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "건강식품").findAll()
        ...
        boardList.add(Board("피부건강", firstList,0))
        boardList.add(Board("다이어트",secondList,0))
        boardList.add(Board("건강식품",thirdList,0))
