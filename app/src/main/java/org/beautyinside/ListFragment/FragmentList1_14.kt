...
class FragmentList1_14 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "컬러렌즈").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "투명렌즈").findAll()
        ...
        val thirdAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "렌즈용품").findAll()
        ...
        boardList.add(Board("컬러렌즈", firstList,0))
        boardList.add(Board("투명렌즈",secondList,0))
        boardList.add(Board("렌즈용품",thirdList,0))
