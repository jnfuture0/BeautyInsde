...
class FragmentList1_8 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "마스크").findAll()
        ...
        boardList.add(Board("마스크", firstList,0))
