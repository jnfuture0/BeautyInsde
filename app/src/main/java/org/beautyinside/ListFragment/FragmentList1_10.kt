...
class FragmentList1_10 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "바디로션/크림").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "바디오일/밤").findAll()
        ...
        val thirdAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "바디미스트").findAll()
        ...
        val fourthAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "바디슬리밍").findAll()
        ...
        val fifthAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "데오드란트").findAll()
        ...
        val sixAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "바디마사지").findAll()
        ...
        boardList.add(Board("바디로션/크림", firstList,0))
        boardList.add(Board("바디오일/밤",secondList,0))
        boardList.add(Board("바디미스트",thirdList,0))
        boardList.add(Board("바디슬리밍",fourthList,0))
        boardList.add(Board("데오드란트",fifthList,0))
        boardList.add(Board("바디마사지",sixList,0))
