...
class FragmentList1_11 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "샴푸").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "린스/컨디셔너").findAll()
        ...
        val thirdAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "트리트먼트").findAll()
        ...
        val fourthAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "스타일링").findAll()
        ...
        boardList.add(Board("샴푸", firstList,0))
        boardList.add(Board("린스/컨디셔너",secondList,0))
        boardList.add(Board("트리트먼트",thirdList,0))
        boardList.add(Board("스타일링",fourthList,0))
