...
class FragmentList1_13 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "여성용품").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "위생용품").findAll()
        ...
        boardList.add(Board("여성용품", firstList,0))
        boardList.add(Board("위생용품",secondList,0))
