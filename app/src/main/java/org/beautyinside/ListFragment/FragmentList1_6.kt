...
class FragmentList1_6 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "브러시").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "스펀지/퍼프").findAll()
        ...
        val thirdAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "메이크업소품").findAll()
        ...
        boardList.add(Board("브러시", firstList,0))
        boardList.add(Board("스펀지/퍼프",secondList,0))
        boardList.add(Board("메이크업소품",thirdList,0))
