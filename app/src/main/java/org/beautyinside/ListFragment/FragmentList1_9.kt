...
class FragmentList1_9 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "선크림").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "선스틱").findAll()
        ...
        val thirdAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "선젤").findAll()
        ...
        val fourthAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "선스프레이").findAll()
        ...
        boardList.add(Board("선크림", firstList,0))
        boardList.add(Board("선스틱",secondList,0))
        boardList.add(Board("선젤",thirdList,0))
        boardList.add(Board("선스프레이",fourthList,0))
