...
class FragmentList1_7 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "페이셜클렌저").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "메이크업클렌저").findAll()
        ...
        val thirdAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "포인트리무버").findAll()
        ...
        val fourthAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "각질케어").findAll()
        ...
        val fifthAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "클렌징도구").findAll()
        ...
        boardList.add(Board("페이셜클렌저", firstList,0))
        boardList.add(Board("메이크업클렌저",secondList,0))
        boardList.add(Board("포인트리무버",thirdList,0))
        boardList.add(Board("각질케어",fourthList,0))
        boardList.add(Board("클렌징도구",fifthList,0))
