...
class FragmentList1_3 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "립스틱").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "틴트/라커").findAll()
        ...
        val thirdAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "립펜슬").findAll()
        ...
        val fourthAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "립글로즈").findAll()
        ...
        val fifthAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "립베이스").findAll()
        ...
        val sixAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "립케어").findAll()
        ...
        boardList.add(Board("립스틱", firstList,0))
        boardList.add(Board("틴트/라커",secondList,0))
        boardList.add(Board("립펜슬",thirdList,0))
        boardList.add(Board("립글로즈",fourthList,0))
        boardList.add(Board("립베이스",fifthList,0))
        boardList.add(Board("립케어",sixList,0))
