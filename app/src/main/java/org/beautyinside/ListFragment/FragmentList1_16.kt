...
class FragmentList1_16 : Fragment() {
    ...
    override fun onResume() {
        ...
        val firstAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "뷰티디바이스").findAll()
        ...
        val secondAll = MainActivity.realm.where(BoardInnerRealm::class.java).equalTo("category", "헤어디바이스").findAll()
        ...
        boardList.add(Board("뷰티디바이스", firstList,0))
        boardList.add(Board("헤어디바이스",secondList,0))
